<div class="bg-white py-4 px-32 d-flex justify-content-between align-items-center border-bottom" style="height: 130.4px;">
	...
	<button class="btn bg-light-sky-blue-tint-90 btn-sm position-relative d-flex justify-content-between align-items-center rounded-16 p-3 view-cart" style="min-width: 115px;">
		...
		<span class="ms-2 fs-24 line-height-32 qtyCart fw-medium">0</span>
	</button>
	@endif
</div>