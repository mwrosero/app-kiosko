...
<script>
	...
	async function cargarMisTratamientos(showLoader = true){
        ...
        if(data.data.length == 0){
        	...
        	$('#content-area').html(`<div class="text-center mt-5 pt-5">
					...
					<p class="text-center py-40 mb-0 fs-28 line-height-32">No tienes tratamientos <br> pendientes.</p>
	...
	function drawCardItem(detalle){
		...
		return `<div class="col-6 col-md-6 box-agenda mb-3 d-flex">
				<div class="rounded-16 border-royal-blue-tint-60 border-inside p-12 d-flex justify-content-between align-items-stretch h-100 w-100">
